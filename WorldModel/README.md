...
nur Mustererkennung. WorldModel speichert und verwaltet kausale Graphen.
...
WorldModel unterstützt alle 3 Ebenen. Ebene 3 delegiert an LogicBrain `counterfactual_branch`.
...
- LogicBrain-Client (Kontrafaktische Verifikation)
...
- `../LogicBrain/` — counterfactual_branch Tool
