"""Check predicate benchmark answer files against expected labels."""
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Check predicate benchmark answers")
    parser.add_argument(
        "--benchmarks",
        type=Path,
        default=Path("benchmarks/predicate_problems.json"),
        help="Path to predicate benchmark problems JSON",
    )
    parser.add_argument(
        "--answers",
        type=Path,
        default=Path("results/predicate_answers.json"),
        help="Path to predicate answers JSON",
    )
